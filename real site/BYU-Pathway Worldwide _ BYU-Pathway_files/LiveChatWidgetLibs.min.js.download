...
/*! markdown-it-for-inline 0.1.1 https://github.com//markdown-it/markdown-it-for-inline @license MIT */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var n;n="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,n.markdownitForInline=e()}}(function(){return function e(n,r,o){function t(i,u){if(!r[i]){if(!n[i]){var d="function"==typeof require&&require;if(!u&&d)return d(i,!0);if(f)return f(i,!0);var l=new Error("Cannot find module '"+i+"'");throw l.code="MODULE_NOT_FOUND",l}var p=r[i]={exports:{}};n[i][0].call(p.exports,function(e){var r=n[i][1][e];return t(r?r:e)},p,p.exports,e,n,r,o)}return r[i].exports}for(var f="function"==typeof require&&require,i=0;i<o.length;i++)t(o[i]);return t}({1:[function(e,n,r){"use strict";n.exports=function(e,n,r,o){function t(e){var n,t,f;for(t=e.tokens.length-1;t>=0;t--)if("inline"===e.tokens[t].type)for(f=e.tokens[t].children,n=f.length-1;n>=0;n--)f[n].type===r&&o(f,n)}e.core.ruler.push(n,t)}},{}]},{},[1])(1)});


// "name": "slack-markdown-it",
// "version": "1.0.4",
// "author": {
//   "name": "Maya Shavin",
//   "email": "dpnminh@gmail.com",
//   "url": "https://mayashavin.com"
// },
!(function (e, n) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports["slack-markdown-it"] = n())
        : (e["slack-markdown-it"] = n());
})(window, function () {
    return (function (e) {
        var n = {};
        function t(r) {
        ...
        function (e, n, t) {
            ...
            var l = function () {
                    ...
                    return o(o({}, e), {}, { type: t ? "strong_".concat(n ? "open" : "close") : "em_".concat(n ? "open" : "close"), tag: t ? "strong" : "em", nesting: n ? 1 : -1, markup: r, content: "" });
                },
                s = {
                    tokenize: function (e, n) {
                        var t = e.src.charCodeAt(e.pos);
                        if (n || (42 !== t && 95 !== t)) return !1;
                        var r = e.scanDelims(e.pos, 42 === t);
                        for (var o = 0; o < r.length; o++) {
                                (e.push("text", "", 0).content = String.fromCharCode(t)),
                                e.delimiters.push({ marker: t, length: r.length, jump: o, token: e.tokens.length - 1, level: e.level, end: -1, open: r.can_open, close: r.can_close });
                        }
                        return (e.pos += r.length), !0;
                    },
                    postProcess: function (e) {
                        for (var n = e.delimiters, t = n.length - 1; t >= 0; t--) {
                            var r = n[t];
                            if ((42 === r.marker || 95 === r.marker) && -1 !== r.end) {
                                var o = n[r.end],
                                    i = 42 === r.marker,
                                    s = String.fromCharCode(r.marker);
                                (e.tokens[r.token] = l(e.tokens[r.token], !0, i, s)), (e.tokens[o.token] = l(e.tokens[o.token], !1, i, s));
                            }
                        }
                    },
                },
                a = {
                    tokenize: function (e, n) {
                        var t = e.src.charCodeAt(e.pos);
                        if (n || 126 !== t) return !1;
                        for (var r = e.scanDelims(e.pos, !0), o = String.fromCharCode(t), i = 0; i < r.length; i++) {
                            (e.push("text", "", 0).content = o), e.delimiters.push({ marker: t, jump: i, token: e.tokens.length - 1, level: e.level, end: -1, open: r.can_open, close: r.can_close });
                        }
                        return (e.pos += r.length), !0;
                    },
                    postProcess: function (e) {
                        for (var n = [], t = e.delimiters, r = 0; r < t.length; r++) {
                            var o = t[r];
                            if (126 === o.marker && -1 !== o.end) {
                                var i = t[o.end],
                                    l = e.tokens[o.token];
                                (l.type = "s_open"), (l.tag = "s"), (l.nesting = 1), (l.markup = "~"), (l.content = "");
                                var s = e.tokens[i.token];
                                (s.type = "s_close"), (s.tag = "s"), (s.nesting = -1), (s.markup = "~"), (s.content = ""), "text" === e.tokens[i.token - 1].type && "~" === e.tokens[i.token - 1].content && n.push(i.token - 1);
                            }
                        }
                    },
                };
            n.default = function (e) {
                var n = e.inline.ruler.__find__("emphasis");
                e.inline.ruler.__rules__[n] = { name: "emphasis", enabled: !0, fn: s.tokenize, alt: [] };
                var t = e.inline.ruler2.__find__("emphasis");
                e.inline.ruler2.__rules__[t] = { name: "emphasis", enabled: !0, fn: s.postProcess, alt: [] };
                var r = e.inline.ruler.__find__("strikethrough");
                e.inline.ruler.__rules__[r] = { name: "strikethrough", enabled: !0, fn: a.tokenize, alt: [] };
                var o = e.inline.ruler2.__find__("strikethrough");
                e.inline.ruler2.__rules__[o] = { name: "strikethrough", enabled: !0, fn: a.postProcess, alt: [] };
            };
        },
    ]);
});
...
// Version: 2.1.1
// URL: https://unpkg.com/simple-update-in@2.1.1/dist/simple-update-in.production.min.js
